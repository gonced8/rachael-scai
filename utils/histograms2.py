...
def get_success_fail(data, metric):
    return np.array_split(data.sort_values(by=metric, ascending=False), 2)
...
def analyze(filename):
    ...
    (
        ...
        *get_success_fail(splits["ROUGE1-R success"], "MRR"),
        *get_success_fail(splits["ROUGE1-R fail"], "MRR"),
    )
