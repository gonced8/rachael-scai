...
#CUDA_VISIBLE_DEVICES=0 python -m pyserini.dindex --corpus data/qrecc/collection/ --encoder castorini/tct_colbert-msmarco --index data/qrecc/dense_index-8 --batch 64 --device cuda:0 --shard-id 8 --shard-num 10 > index-8.txt 2>&1 &
#CUDA_VISIBLE_DEVICES=1 python -m pyserini.dindex --corpus data/qrecc/collection/ --encoder castorini/tct_colbert-msmarco --index data/qrecc/dense_index-9 --batch 64 --device cuda:0 --shard-id 9 --shard-num 10 > index-9.txt 2>&1 &
