...
ax2.plot(val_epoch, rouge1["Value"], lw=3, label="x=1")
ax2.plot(val_epoch, rouge2["Value"], ls="dashed", lw=3, label="x=2")
ax2.plot(val_epoch, rougeL["Value"], ls="dotted", lw=3, label="x=L")
